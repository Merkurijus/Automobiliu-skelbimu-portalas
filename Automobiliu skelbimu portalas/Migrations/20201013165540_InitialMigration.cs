        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastName = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ViewedList", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ViewedList_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SteeringWheel = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MarkedList", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MarkedList_Ads_AdId",
                        column: x => x.AdId,
                        principalTable: "Ads",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MarkedList_AspNetUsers_UserId1",
                        column: x => x.UserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MarkedList_AdId",
                table: "MarkedList",
                column: "AdId");

            migrationBuilder.CreateIndex(
                name: "IX_MarkedList_UserId1",
                table: "MarkedList",
                column: "UserId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SearchesList_UserId",
                table: "SearchesList",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_ViewedList_UserId",
                table: "ViewedList",
                column: "UserId");
        }
